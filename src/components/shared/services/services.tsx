      ...
      <section className="py-20 px-4 md:px-10 bg-white">
          ...
          <div className="mt-24 flex flex-col md:flex-row items-center justify-between gap-10">
              ...
              <div className="md:w-1/2 w-full text-center md:text-left">
                  <div
                      className="inline-block border-2 border-yellow-400 px-5 py-1 rounded-full text-sm font-medium text-gray-700 mb-5">
                      Why Choose Us?
                  </div>
          ...
          <div className="mt-20 flex justify-center">
              <a
                  href="https://wa.link/fakcpo"
                  target="_blank"
                  rel="noopener noreferrer"
              >
                  <button
                      className="bg-[#0018a8] hover:bg-blue-900 text-white font-semibold px-10 py-3 rounded-full transition">
                      Book Now!
                  </button>
              </a>
          </div>
